...
<div class="bg-gray-300 rounded py-4 px-2">
    ...
    <div>
        ...
        <input type="text" value="{{$category->nombre}}" name="nombre" id="nombre" class="py-1 px-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="nombre" required>
        @error('nombre')
    ...
    <div class="mt-2">
        <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold"><i class="fas fa-edit"></i>Editar</button>
